...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The 確認_退会処理後_画面表示 recording.
    /// </summary>
    [TestModule("164ba5ed-4bca-4930-b80d-690888ccf05c", ModuleType.Recording, 1)]
    public partial class 確認_退会処理後_画面表示 : ITestModule
    {
        /// <summary>
        ...
        static 確認_退会処理後_画面表示 instance = new 確認_退会処理後_画面表示();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public 確認_退会処理後_画面表示()
        {
        }
        ...
        /// </summary>
        public static 確認_退会処理後_画面表示 Instance
        {
            get { return instance; }
        }
